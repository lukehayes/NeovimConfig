...
local group = vim.api.nvim_create_augroup("MYTESTGROUP", {clear = true})
vim.api.nvim_create_autocmd({"BufWritePost"}, {
    pattern = {"*"},
    callback = function(ev)

        local messages = {
            "You're looking fly today. Go you.",
            "You just saved that post LIKE A BOSS, wow!",
            "You're amazing.",
            "Damn, you're great",
            "Crushing it!!!",
        ...
        print(messages[math.random(1,#messages - 1)])
    end,
    group = group
})
